...
A memory system that never forgets. Persistent fractal memory for Claude Code. Raw conversations → themes → insights. Core Memory loads every session. Local-first, zero config.
